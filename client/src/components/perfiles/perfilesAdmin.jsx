...
export default function PerfilesAdmin(){
    ...
    return (
        <div className='perfilesAdmin'>
            ...
            {profiles.map((e,i)=><div className="perfiles_foto_nombre" key={i}><img className="foto_perfil_admin" src={e.foto}></img><NavLink style={{"textDecoration": "none"}}key={e._id} to={`profile/${e._id}`}>
